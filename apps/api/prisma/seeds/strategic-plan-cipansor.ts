...
export async function seedStrategicPlans(prisma: PrismaClient, u: StrategicPlanSeedUsers) {
      ...
      objectives: {
        create: [
            ...
            indicators: {
              create: [
                indicator({
                  ...
                  targetValue: 3,
                  currentValue: 1,
                  level: PlanIndicatorLevel.IUP,
                  definition:
                    'Jumlah satuan pendidikan formal (SDIT, SMP IT, SMA) berpredikat akreditasi A/Unggul.',
                  formula: 'COUNT(unit dengan peringkat A/Unggul)',
                  dataSource: 'SK & Sispena BAN-PDM',
                  frequency: 'Tahunan',
                  picRole: 'Pengurus & Kepala Sekolah',
                  targets: [
                ...
                indicator({
                  ...
                  level: PlanIndicatorLevel.IUP,
                  definition:
                    "Rata-rata juz hafalan mutqin (lulus tasmi') seluruh lulusan SMA tahun berjalan.",
                  formula: 'AVG(juz hafalan lulusan SMA)',
                  dataSource: 'Buku induk tahfidz pesantren',
                  frequency: 'Tahunan (kelulusan)',
                  picRole: 'Koordinator Tahfidz',
                  targets: [
          ...
          },
          {
            ...
            description:
              'Kontribusi unit usaha syariah & wakaf produktif terhadap anggaran naik dari < 10% menjadi > 40%.',
            indicators: {
              create: [
                indicator({
                  ...
                  level: PlanIndicatorLevel.IUP,
                  definition:
                    'Rasio pendapatan unit usaha & wakaf produktif terhadap total anggaran tahunan Yayasan.',
                  formula: '(Pendapatan mandiri ÷ Total anggaran) × 100%',
                  dataSource: 'Laporan keuangan konsolidasi',
                  frequency: 'Tahunan',
                  picRole: 'Bendahara & Manajer Unit Usaha',
                  targets: [
                    { period: 'Tahap I (2029)', targetValue: 10 },
          ...
          },
          {
            ...
            description:
              'Penerima manfaat santunan & beasiswa per tahun tumbuh dari ±40 menjadi 400+ orang.',
            indicators: {
              create: [
                indicator({
                  ...
                  level: PlanIndicatorLevel.IUP,
                  definition:
                    'Jumlah orang unik penerima santunan/beasiswa/layanan sosial dalam satu tahun.',
                  formula: 'COUNT DISTINCT(penerima manfaat per tahun)',
                  dataSource: 'Register penerima manfaat Bidang Sosial',
                  frequency: 'Tahunan',
                  picRole: 'Koordinator Bidang Sosial',
                  targets: [
            ...
            indicators: {
              create: [
                indicator({
                  ...
                  level: PlanIndicatorLevel.IUP,
                  definition:
                    'Tingkat kematangan tata kelola: 1 review internal → 5 audit independen rutin + sistem informasi terintegrasi penuh.',
                  formula: 'Penilaian tahunan skala 1–5',
                  dataSource: 'Laporan hasil review/audit',
                  frequency: 'Tahunan',
                  picRole: 'Bendahara & Sekretaris Yayasan',
                  targets: [
          ...
          },
          {
            ...
            description:
              'Jangkauan pengakuan naik dari tingkat kecamatan menjadi rujukan Jawa Barat. Skala 1 (kecamatan) – 5 (Jawa Barat).',
            indicators: {
              create: [
                indicator({
                  ...
                  level: PlanIndicatorLevel.IUP,
                  definition:
                    'Skala jangkauan pengakuan: 1 kecamatan → 3 Priangan Timur → 5 rujukan Jawa Barat.',
                  formula: 'Penilaian tahunan skala 1–5',
                  dataSource: 'Status kemitraan & pengakuan eksternal',
                  frequency: 'Tahunan',
                  picRole: 'Ketua Pengurus',
                  targets: [
                    { period: 'Tahap I (2029)', targetValue: 2 },
                    { period: 'Tahap II (2034)', targetValue: 3 },
                    { period: 'Tahap III (2039)', targetValue: 4 },
              ...
              indicators: {
                create: [
                  indicator({
                    name: `IKK — ${k.ikk.name}`,
                    unit: k.ikk.unit,
                    targetValue: k.ikk.y2029,
                    currentValue: k.ikk.y2027 ?? 0,
                    level: PlanIndicatorLevel.IKK,
                    frequency: 'Tahunan',
                    targets: yearTargets(k.ikk),
                  }),
                ],
              },
            })),
  ...
  const ss1Programs: ProgramSeed[] = [
    {
      code: '1.A.1',
      name: 'Penguatan Kurikulum Payung Keislaman Lintas Jenjang',
      outcome: 'Kerangka kurikulum keislaman konsisten dari TK hingga SMA.',
      ikp: 'Diterapkan & disempurnakan di seluruh jenjang',
      picId: u.ketua,
      kegiatan: [
        {
          code: '1.A.1.a',
          title: 'Penyusunan kurikulum payung keislaman lintas jenjang',
          sasaran: '1 dokumen kurikulum payung acuan seluruh jenjang.',
          ikk: {
            name: 'Status dokumen kurikulum payung',
            unit: 'tahap',
            y2027: 1,
            y2028: 2,
            y2029: 3,
    ...
    {
      code: '1.A.2',
      name: 'Digitalisasi Sistem Informasi Akademik Terpadu ("Smart Pesantren")',
      outcome: 'Satu sistem informasi akademik & administrasi menaungi TKQ, SDIT, SMP IT, SMA.',
      ikp: 'Terintegrasi penuh 4 jenjang; 90% wali santri aktif',
      picId: u.sekretaris,
      kegiatan: [
        {
          code: '1.A.2.a',
          title: 'Pengadaan & pengembangan aplikasi informasi akademik terpadu',
          sasaran: 'Satu sistem informasi untuk seluruh jenjang.',
          ikk: { name: 'Cakupan integrasi sistem', unit: 'jenjang', y2027: 2, y2028: 3, y2029: 4 },
          picId: u.sekretaris,
        },
        {
          code: '1.A.2.b',
          title: 'Migrasi pembayaran SPP & asrama ke non-tunai',
          sasaran: 'Transparansi transaksi keuangan dengan wali santri meningkat.',
          ikk: { name: 'Transaksi SPP non-tunai', unit: '%', y2027: 40, y2028: 75, y2029: 100 },
          picId: u.sekretaris,
        },
      ],
    },
    {
      code: '1.A.3',
      name: 'Peningkatan Kompetensi Pendidik Lintas Jenjang',
      outcome: 'Kualifikasi & sertifikasi pendidik meningkat merata.',
      ikp: '90% pendidik tersertifikasi/berkualifikasi',
      picId: u.koordinator,
      kegiatan: [
        {
          code: '1.A.3.a',
          title: 'Fasilitasi sertifikasi & studi lanjut guru',
          sasaran: 'Jumlah guru bersertifikat/berkualifikasi S1 meningkat.',
          ikk: {
            name: 'Guru difasilitasi sertifikasi/studi',
            unit: 'orang/th',
            y2027: 7,
            y2028: 9,
            y2029: 9,
    ...
    {
      code: '1.A.4',
      name: 'Pengembangan Fasilitas Bersama & Eco-Pesantren Sehat',
      outcome: 'Fasilitas ibadah, aula, asrama representatif, sehat, ramah lingkungan.',
      ikp: 'Difungsikan penuh; sanitasi terstandar',
      picId: u.ketua,
    },
    {
      code: '1.A.5',
      name: 'Pesantren Ramah Anak (Selaras KMA No. 91/2025)',
      outcome: 'Lingkungan pesantren aman, bebas kekerasan, ramah anak di seluruh jenjang.',
      ikp: 'Fase Kemandirian PRA tercapai; nihil kasus tidak tertangani',
      picId: u.koordinator,
      kegiatan: [
        {
          code: '1.A.5.a',
          title: 'Pembentukan unit BK & pelatihan guru BK ramah anak',
          sasaran: 'Layanan BK profesional di seluruh jenjang.',
          ikk: {
            name: 'Unit sekolah dengan BK aktif (kumulatif)',
            unit: 'unit',
            y2027: 2,
            y2028: 3,
            y2029: 4,
    ...
    {
      code: '1.C.1',
      name: 'Penguatan Mutu Akademik & Akreditasi SDIT',
      outcome: 'Mutu pembelajaran dasar meningkat & akreditasi A SDIT terjaga.',
      ikp: 'A (dipertahankan melalui reakreditasi)',
      picId: u.kepalaSd,
      kegiatan: [
        {
          code: '1.C.1.a',
          title: 'Penguatan literasi & numerasi dasar (calistung)',
          sasaran: 'Kemampuan baca-tulis-hitung siswa kelas 1–3 meningkat.',
          ikk: {
            name: 'Siswa kelas awal mencapai standar calistung',
            unit: '%',
            y2027: 80,
            y2028: 90,
            y2029: 95,
    ...
    {
      code: '1.C.2',
      name: 'Perluasan Akses & Sarpras SDIT',
      outcome: 'Jumlah peserta didik, beasiswa, & sarpras dasar SDIT meningkat.',
      ikp: '+35% siswa (kumulatif 3 tahun); sarpras 100%',
      picId: u.kepalaSd,
      priority: PlanPriority.MEDIUM,
      kegiatan: [
        {
          code: '1.C.2.a',
          title: 'Beasiswa & subsidi silang santri dhuafa/yatim jenjang SD',
          sasaran: 'Beasiswa bagi siswa SD kurang mampu tersalurkan.',
          ikk: { name: 'Penerima beasiswa SD', unit: 'siswa/th', y2027: 8, y2028: 10, y2029: 12 },
          picId: u.kepalaSd,
        },
      ],
    },
    {
      code: '1.D.1',
      name: 'Penguatan Mutu Akademik & Akreditasi SMP IT',
    ...
    {
      code: '1.D.2',
      name: 'Pemenuhan Sarpras & Akses SMP IT',
      outcome: 'Sarpras laboratorium terpenuhi & akses/beasiswa siswa SMP meningkat.',
      ikp: '100% sarpras; 10 penerima beasiswa',
      picId: u.kepalaSmp,
      priority: PlanPriority.MEDIUM,
      kegiatan: [
        {
          code: '1.D.2.a',
          title: 'Pengembangan laboratorium IPA & komputer SMP',
          sasaran: 'Laboratorium layak untuk praktik.',
          ikk: {
            name: 'Capaian standar laboratorium SMP',
            unit: '%',
            y2027: 70,
            y2028: 90,
            y2029: 100,
    ...
    {
      code: '1.E.1',
      name: "Penguatan Mutu Akademik & Akreditasi SMA Qur'an",
    ...
    {
      code: '1.E.2',
      name: 'Bimbingan Karier, PTN & Kewirausahaan Santri',
      outcome: 'Keterserapan lulusan ke PT/dunia kerja & jiwa kewirausahaan meningkat.',
      ikp: '50% lulusan terserap PTN/kerja',
      picId: u.kepalaSma,
      priority: PlanPriority.MEDIUM,
      kegiatan: [
        {
          code: '1.E.2.a',
          title: 'Bimbingan karier & try out PTN',
          sasaran: 'Bimbingan karier terjadwal bagi kelas akhir.',
          ikk: {
            name: 'Lulusan diterima PTN/dunia kerja',
            unit: '%',
            y2027: 30,
            y2028: 40,
            y2029: 50,
  ...
  const ss2Programs: ProgramSeed[] = [
    {
      code: '2.1',
      name: 'Penguatan Tahfidz & Tahsin Berjenjang',
      outcome: "Capaian hafalan Al-Qur'an santri meningkat bertingkat sesuai jenjang.",
      ikp: 'Rata-rata hafalan lulusan SMA 10 juz',
      picId: u.koordinator,
      kegiatan: [
        {
          code: '2.1.a',
          title: 'Pembinaan tahfidz intensif santri SMA',
          sasaran: 'Target hafalan menjelang kelulusan SMA tercapai.',
          ikk: {
            name: 'Hafalan lulusan SMA (kumulatif)',
            unit: 'juz',
            y2027: 8,
            y2028: 9,
            y2029: 10,
        ...
        {
          code: '2.1.b',
          title: 'Halaqah & kajian kitab rutin lintas jenjang',
          sasaran: 'Frekuensi kajian rutin meningkat.',
          ikk: {
            name: 'Halaqah/kajian per pekan',
            unit: 'halaqah',
            y2027: 8,
            y2028: 10,
            y2029: 12,
    ...
    {
      code: '2.2',
      name: "Penguatan TKQ sebagai Pintu Masuk Generasi Qur'ani",
      outcome: 'TKQ aman & mendidik sebagai jenjang non-formal keagamaan pertama.',
      ikp: '80 santri TKQ aktif',
      picId: u.koordinator,
      priority: PlanPriority.MEDIUM,
      kegiatan: [
        {
          code: '2.2.a',
          title: 'Penerimaan & pembinaan santri TKQ',
          sasaran: 'Jumlah santri TKQ bertambah.',
          ikk: { name: 'Santri TKQ aktif', unit: 'santri', y2027: 55, y2028: 70, y2029: 80 },
          picId: u.koordinator,
        },
      ],
    },
    {
      code: '2.3',
      name: 'Dakwah & Pembinaan Masyarakat Sekitar',
      outcome: 'Jangkauan syiar & layanan keagamaan masyarakat sekitar meningkat.',
      ikp: '5 majelis taklim binaan; KBIH beroperasi',
      picId: u.koordinator,
      priority: PlanPriority.MEDIUM,
      kegiatan: [
        {
          code: '2.3.a',
          title: 'Pembinaan & pendampingan majelis taklim',
          sasaran: 'Majelis taklim binaan aktif bertambah.',
          ikk: { name: 'Majelis taklim binaan', unit: 'majelis', y2027: 3, y2028: 4, y2029: 5 },
          picId: u.koordinator,
        },
      ],
    },
    {
      code: '2.4',
      name: 'Pengelolaan ZISWAF dan Qurban',
      outcome: 'Penghimpunan & penyaluran ZISWAF dan hewan qurban optimal.',
      ikp: 'Rp350 juta ZISWAF per tahun',
      picId: u.koordinator,
      priority: PlanPriority.MEDIUM,
      kegiatan: [
        {
          code: '2.4.a',
          title: 'Penghimpunan & penyaluran ZISWAF',
          sasaran: 'Dana ZISWAF terhimpun & tersalurkan meningkat.',
          ikk: {
            name: 'Dana ZISWAF per tahun',
            unit: 'Rp juta',
            y2027: 200,
            y2028: 275,
            y2029: 350,
  ...
  const ss3Programs: ProgramSeed[] = [
    {
      code: '3.1',
      name: 'Santunan & Perlindungan Sosial',
      outcome: 'Jumlah & kualitas layanan santunan bagi yatim, dhuafa, masyarakat meningkat.',
      ikp: '85 penerima santunan per tahun',
      picId: u.koordinator,
      kegiatan: [
        {
          code: '3.1.a',
          title: 'Santunan rutin anak yatim & dhuafa',
          sasaran: 'Jumlah penerima santunan bertambah.',
          ikk: {
            name: 'Penerima santunan per tahun',
            unit: 'orang',
            y2027: 55,
            y2028: 70,
            y2029: 85,
    ...
    {
      code: '3.2',
      name: 'Pemberdayaan Ekonomi & Tanggap Bencana',
      outcome: 'Kemandirian ekonomi keluarga dhuafa & kesiapsiagaan bencana meningkat.',
      ikp: '25 KK penerima manfaat pemberdayaan',
      picId: u.koordinator,
      priority: PlanPriority.MEDIUM,
      kegiatan: [
        {
          code: '3.2.a',
          title: 'Pelatihan & pendampingan usaha kecil keluarga dhuafa',
          sasaran: 'Keluarga penerima manfaat pemberdayaan bertambah.',
          ikk: { name: 'KK penerima pemberdayaan', unit: 'KK', y2027: 15, y2028: 20, y2029: 25 },
          picId: u.koordinator,
        },
      ],
    },
    {
      code: '3.3',
      name: 'Kepedulian Lingkungan Hidup',
      outcome: 'Kualitas & kelestarian lingkungan pesantren & sekitarnya meningkat.',
      ikp: '3 kegiatan pelestarian lingkungan per tahun',
      picId: u.koordinator,
      priority: PlanPriority.LOW,
      kegiatan: [
        {
          code: '3.3.a',
          title: 'Penghijauan & kebersihan lingkungan pesantren',
          sasaran: 'Kegiatan penghijauan rutin terlaksana.',
          ikk: {
            name: 'Kegiatan lingkungan per tahun',
            unit: 'kegiatan',
            y2027: 2,
            y2028: 2,
            y2029: 3,
  ...
  const ss4Programs: ProgramSeed[] = [
    {
      code: '4.1',
      name: 'Penguatan Tata Kelola & Kepatuhan Regulasi',
      outcome: 'Kepatuhan administrasi Yayasan sesuai UU Yayasan & peraturan pendidikan.',
      ikp: '100% kepatuhan pelaporan tahunan & perizinan',
      picId: u.sekretaris,
      kegiatan: [
        {
          code: '4.1.a',
          title: 'Rapat Pembina & laporan tahunan tepat waktu',
          sasaran: 'Rapat & laporan tahunan terlaksana tepat waktu (Ps. 35 AD).',
          ikk: {
            name: 'Ketepatan pelaporan tahunan',
            unit: '%',
            y2027: 100,
            y2028: 100,
            y2029: 100,
    ...
    {
      code: '4.2',
      name: 'Penguatan Akuntabilitas Keuangan',
      outcome: 'Transparansi & akuntabilitas pengelolaan keuangan Yayasan meningkat.',
      ikp: 'Laporan keuangan diaudit rutin',
      picId: u.bendahara,
      kegiatan: [
        {
          code: '4.2.a',
          title: 'Penyusunan & review/audit laporan keuangan tahunan',
          sasaran: 'Laporan keuangan sesuai standar akuntansi.',
          ikk: {
    ...
    {
      code: '4.3',
      name: 'Pengembangan Kapasitas SDM Kepengurusan',
      outcome: 'Kapasitas manajerial Pembina, Pengurus, Pengawas & kepala unit meningkat.',
      ikp: '4 pelatihan/bimtek pengurus per tahun',
      picId: u.ketua,
      priority: PlanPriority.MEDIUM,
      kegiatan: [
        {
          code: '4.3.a',
          title: 'Pelatihan manajemen kelembagaan & keuangan yayasan',
          sasaran: 'Pelatihan bagi pengurus & kepala unit terlaksana.',
          ikk: { name: 'Pelatihan pengurus per tahun', unit: 'kali', y2027: 3, y2028: 4, y2029: 4 },
          picId: u.ketua,
        },
      ],
    },
  ...
  const ss5Programs: ProgramSeed[] = [
    {
      code: '4.4',
      name: 'Kemandirian Finansial melalui Vokasi & OPOP',
      outcome: 'Kontribusi pendanaan mandiri meningkat via BLK Bahasa, Kopontren, OPOP.',
      ikp: '4 unit usaha aktif; meraih pengakuan OPOP berprestasi',
      picId: u.koordinator,
      kegiatan: [
        {
          code: '4.4.a',
          title: 'Optimalisasi BLK Kejuruan Bahasa (Arab-Inggris)',
          sasaran: 'BLK berjalan sebagai sumber pendapatan & skill santri.',
          ikk: { name: 'Peserta kursus BLK', unit: 'peserta', y2027: 20, y2028: 35, y2029: 50 },
          picId: u.koordinator,
        },
      ],
    },
            ...
            [
              {
                ...
                targetValue: 3,
                currentValue: 1,
                level: PlanIndicatorLevel.IKU,
                definition:
                  'Status/peringkat akreditasi tiap unit formal berdasarkan SK BAN-PDM terakhir.',
                formula: 'COUNT(unit A)',
                dataSource: 'SK & Sispena BAN-PDM',
                frequency: 'Tahunan',
                picRole: 'Pengurus & Kepala Sekolah',
                targets: [
                  { period: '2027', targetValue: 1 },
                  { period: '2028', targetValue: 2 },
                  { period: '2029', targetValue: 3 },
                ],
              },
              {
                ...
                level: PlanIndicatorLevel.IKU,
                definition:
                  '(Pendidik bersertifikat atau berkualifikasi min. S1 ÷ total pendidik) × 100%.',
                formula: '(Σ bersertifikat ÷ Σ pendidik) × 100%',
                dataSource: 'Data kepegawaian Yayasan',
                frequency: 'Semesteran',
                picRole: 'Sekretaris Yayasan',
                targets: [
                  { period: '2027', targetValue: 75 },
                  { period: '2028', targetValue: 85 },
                  { period: '2029', targetValue: 90 },
                ],
              },
            ],
            ss1Programs
            ...
            [
              {
                ...
                currentValue: 8,
                level: PlanIndicatorLevel.IKU,
                definition: 'Rata-rata juz hafalan mutqin lulusan SMA.',
                dataSource: 'Buku induk tahfidz',
                frequency: 'Tahunan',
                picRole: 'Koordinator Tahfidz',
                targets: [
                  { period: '2027', targetValue: 8 },
                  { period: '2028', targetValue: 9 },
                  { period: '2029', targetValue: 10 },
                ],
              },
              {
                ...
                currentValue: 200,
                level: PlanIndicatorLevel.IKU,
                dataSource: 'Laporan Bidang Keagamaan & ZISWAF',
                frequency: 'Triwulanan',
                picRole: 'Koordinator Keagamaan',
                targets: [
                  { period: '2027', targetValue: 200 },
                  { period: '2028', targetValue: 275 },
                  { period: '2029', targetValue: 350 },
                ],
              },
            ],
            ss2Programs
            ...
            [
              {
                ...
                level: PlanIndicatorLevel.IKU,
                definition:
                  'Jumlah orang unik penerima santunan/beasiswa/layanan sosial per tahun.',
                dataSource: 'Register Bidang Sosial',
                frequency: 'Triwulanan',
                picRole: 'Koordinator Sosial',
                targets: [
                  { period: '2027', targetValue: 55 },
                  { period: '2028', targetValue: 70 },
                  { period: '2029', targetValue: 85 },
                ],
              },
            ],
            ss3Programs
            ...
            [
              {
                ...
                level: PlanIndicatorLevel.IKU,
                definition:
                  'Status tertinggi pemeriksaan laporan keuangan: 1 review internal → 4 audit independen.',
                dataSource: 'Laporan hasil review/audit',
                frequency: 'Tahunan',
                picRole: 'Bendahara Yayasan',
                targets: [
                  { period: '2027', targetValue: 2 },
                  { period: '2028', targetValue: 3 },
                  { period: '2029', targetValue: 3 },
                ],
              },
            ],
            ...
            [
              {
                ...
                level: PlanIndicatorLevel.IKU,
                definition:
                  'Jumlah unit usaha (BLK, Kopontren, OPOP, wakaf produktif) yang beroperasi rutin.',
                dataSource: 'Laporan unit usaha',
                frequency: 'Semesteran',
                picRole: 'Manajer Unit Usaha',
                targets: [
                  { period: '2027', targetValue: 2 },
                  { period: '2028', targetValue: 3 },
                  { period: '2029', targetValue: 4 },
                ],
              },
              {
                ...
                targets: [
                  { period: '2027', targetValue: 8 },
                  { period: '2028', targetValue: 10 },
                  { period: '2029', targetValue: 12 },
                ],
              },
            ],
            ss5Programs
  ...
  const q = (
    name: string,
    unit: string,
    tw: [number, number, number, number],
    target: number,
    current: number
  ): IndicatorSeed => ({
    name: `IKK — ${name}`,
    ...
    level: PlanIndicatorLevel.IKK,
    frequency: 'Triwulanan',
    targets: ['TW I', 'TW II', 'TW III', 'TW IV'].map((p, i) => ({
      period: p,
      targetValue: tw[i],
    })),
  });
  ...
  const rkaObjectives: Prisma.PlanObjectiveCreateWithoutPlanInput[] = [
    {
      ...
      activities: {
        create: [
          kegiatan(
            'K-01',
            'Kurikulum Payung Keislaman & Pemetaan Transisi',
            'Kurikulum payung TK–SMA & pemetaan transisi tersusun, mulai diterapkan TP 2027/2028.',
            u.ketua,
            PlanPriority.HIGH,
            ...
            [
              {
                description: 'Honorarium tim penyusun kurikulum',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 12,
              },
              {
                description: 'FGD/rapat kerja kurikulum',
                volume: 4,
                unit: 'kali',
                unitPriceJt: 2.5,
              },
              {
                description: 'Penggandaan dokumen & ATK',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 3,
              },
          ...
          kegiatan(
            'K-02',
            '"Smart Pesantren", Migrasi Non-Tunai & Pelatihan Operator',
            'Aplikasi akademik terpasang & uji coba SD–SMP; 40% SPP non-tunai; operator terlatih.',
            u.sekretaris,
            PlanPriority.HIGH,
            ...
            [
              {
                description: 'Pengembangan/lisensi aplikasi terpadu',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 120,
              },
              {
                description: 'Server/hosting & langganan',
                volume: 12,
                unit: 'bulan',
                unitPriceJt: 2,
              },
              { description: 'Pelatihan operator & guru', volume: 2, unit: 'kali', unitPriceJt: 3 },
            ]
          ),
          kegiatan(
            'K-03',
            'Pelatihan HOTS & Fasilitasi Sertifikasi Pendidik',
            '3 pelatihan pembelajaran aktif & fasilitasi sertifikasi 7 guru.',
            u.koordinator,
            PlanPriority.MEDIUM,
            PlanStatus.IN_PROGRESS,
            ...
            [
              {
                description: 'Narasumber & paket pelatihan',
                volume: 3,
                unit: 'kali',
                unitPriceJt: 8,
              },
              {
                description: 'Fasilitasi sertifikasi/studi lanjut guru',
                volume: 7,
                unit: 'orang',
                unitPriceJt: 5,
              },
          ...
          kegiatan(
            'K-04',
            'Fasilitas Bersama (Masjid/Aula, Asrama Tahap 1) & Eco-Pesantren',
            'Pembangunan masjid/aula & asrama tahap 1 dimulai; sanitasi & Bank Sampah.',
            u.ketua,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Penyusunan DED & perizinan (IMB/PBG)',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 60,
              },
              {
                description: 'Konstruksi masjid/aula tahap 2027',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 850,
              },
              {
                description: 'Konstruksi asrama tahap 1',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 560,
              },
              {
                description: 'Perbaikan sanitasi & pengurasan septik',
                volume: 2,
                unit: 'siklus',
                unitPriceJt: 12,
              },
              {
                description: 'Sarana pemilahan sampah & komposter',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 6,
              },
          ...
          kegiatan(
            'K-05',
            'Pesantren Ramah Anak: Unit BK, Kode Etik & Satgas',
            'BK aktif 2 unit; kode etik & Satgas terbentuk; kanal pengaduan tersedia.',
            u.koordinator,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Pelatihan guru BK & pengasuhan ramah anak',
                volume: 2,
                unit: 'kali',
                unitPriceJt: 8,
              },
              {
                description: 'Penyusunan & sosialisasi kode etik',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 15,
              },
              { description: 'Sarana kanal pengaduan', volume: 1, unit: 'paket', unitPriceJt: 9 },
            ]
          ),
          kegiatan(
            'K-06',
            'Reakreditasi & Penguatan Calistung SDIT',
            'Berkas reakreditasi SDIT diajukan; 80% siswa kelas awal capai standar calistung.',
            u.kepalaSd,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Pendampingan & dokumen reakreditasi',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 12,
              },
              {
                description: 'Media & program calistung',
                volume: 2,
                unit: 'semester',
                unitPriceJt: 4,
              },
          ...
          kegiatan(
            'K-07',
            'PPDB, Beasiswa & Sarpras SDIT',
            'Siswa SDIT +10%; 8 beasiswa; sarpras 75%.',
            u.kepalaSd,
            PlanPriority.MEDIUM,
            PlanStatus.IN_PROGRESS,
            ...
            [
              {
                description: 'Promosi & penyelenggaraan PPDB',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 20,
              },
              {
                description: 'Beasiswa siswa SD dhuafa/yatim',
                volume: 8,
                unit: 'siswa',
                unitPriceJt: 5,
              },
              {
                description: 'Pengembangan ruang kelas & perpustakaan SD',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 60,
              },
          ...
          kegiatan(
            'K-08',
            'Akreditasi & Pembinaan Remaja SMP IT',
            'Berkas kenaikan status disiapkan; 3 sesi pembinaan remaja.',
            u.kepalaSmp,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Pendampingan persiapan akreditasi',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 15,
              },
              {
                description: 'Sesi pembinaan karakter remaja',
                volume: 3,
                unit: 'kali',
                unitPriceJt: 3.3,
              },
          ...
          kegiatan(
            'K-09',
            'Laboratorium & Beasiswa SMP IT',
            'Lab 70%; 7 beasiswa SMP.',
            u.kepalaSmp,
            PlanPriority.MEDIUM,
            PlanStatus.IN_PROGRESS,
            [1, 3, 4, 5, 6, 7, 8, 9, 10],
            ...
            [
              {
                description: 'Peralatan laboratorium IPA & komputer',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 55,
              },
              {
                description: 'Beasiswa siswa SMP dhuafa/yatim',
                volume: 7,
                unit: 'siswa',
                unitPriceJt: 5,
              },
          ...
          kegiatan(
            'K-10',
            "Akreditasi Perdana & Guru Mapel SMA Qur'an",
            ...
            [
              {
                description: 'Pendampingan akreditasi perdana',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 18,
              },
              {
                description: 'Rekrutmen & penguatan guru mapel',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 17,
              },
          ...
          kegiatan(
            'K-11',
            'Karier/PTN & Kewirausahaan Santri SMA',
            '30% lulusan terserap PTN/kerja; 15 siswa kewirausahaan/magang.',
            u.kepalaSma,
            PlanPriority.MEDIUM,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Try out & bimbingan karier',
                volume: 3,
                unit: 'kali',
                unitPriceJt: 5,
              },
              {
                description: 'Program kewirausahaan & magang',
                volume: 15,
                unit: 'siswa',
                unitPriceJt: 1,
              },
          ...
          kegiatan(
            'K-12',
            'Laboratorium & Referensi SMA',
            'Capaian sarpras SMA 70%.',
            u.kepalaSma,
            PlanPriority.MEDIUM,
            PlanStatus.DRAFT,
            [3, 4, 5, 6, 7, 8, 9, 10, 11],
            ...
            [
              {
                description: 'Peralatan laboratorium SMA',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 60,
              },
              {
                description: 'Buku & referensi perpustakaan',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 20,
              },
    ...
    },
    {
      ...
      activities: {
        create: [
          kegiatan(
            'K-13',
            'Tahfidz-Tahsin Berjenjang & Halaqah Rutin',
            'Hafalan lulusan SD 2 / SMP 4 / SMA 8 juz; 8 halaqah/pekan.',
            u.koordinator,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Bisyaroh pembina tahfidz & tahsin',
                volume: 12,
                unit: 'bulan',
                unitPriceJt: 13,
              },
              {
                description: "Wisuda tahfidz & tasmi' akbar",
                volume: 1,
                unit: 'kali',
                unitPriceJt: 15,
              },
              {
                description: "Mushaf, kitab & buku mutaba'ah",
                volume: 1,
                unit: 'paket',
                unitPriceJt: 9,
              },
          ...
          kegiatan(
            'K-14',
            'Penerimaan-Pembinaan Santri TKQ, APE & Pelatihan Pengajar',
            '55 santri TKQ aktif; APE lengkap; 2 pengajar terlatih.',
            u.koordinator,
            PlanPriority.MEDIUM,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'APE & sarana bermain-belajar aman',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 20,
              },
              { description: 'Pelatihan pengajar TKQ', volume: 2, unit: 'orang', unitPriceJt: 2.5 },
              {
                description: 'Operasional pembinaan TKQ',
                volume: 12,
                unit: 'bulan',
                unitPriceJt: 1.67,
              },
          ...
          kegiatan(
            'K-15',
            'Pembinaan Majelis Taklim & Izin KBIH',
            '3 majelis taklim binaan; izin KBIH terbit.',
            u.koordinator,
            PlanPriority.MEDIUM,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Operasional pembinaan majelis taklim',
                volume: 12,
                unit: 'bulan',
                unitPriceJt: 1.5,
              },
              {
                description: 'Pengurusan izin & kelengkapan KBIH',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 12,
              },
          ...
          kegiatan(
            'K-16',
            'Penghimpunan-Penyaluran ZISWAF & Qurban',
            'ZISWAF Rp200 juta (indikatif); 30 ekor qurban.',
            u.koordinator,
            PlanPriority.MEDIUM,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Operasional penghimpunan & publikasi ZISWAF',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 15,
              },
              {
                description: 'Kepanitiaan & distribusi qurban',
                volume: 1,
                unit: 'kali',
                unitPriceJt: 10,
              },
    ...
    },
    {
      ...
      activities: {
        create: [
          kegiatan(
            'K-17',
            'Santunan Yatim-Dhuafa & Layanan Jenazah',
            '55 penerima santunan; layanan jenazah ditingkatkan.',
            u.koordinator,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              { description: 'Santunan yatim & dhuafa', volume: 55, unit: 'orang', unitPriceJt: 2 },
              {
                description: 'Perlengkapan & operasional layanan jenazah',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 30,
              },
          ...
          kegiatan(
            'K-18',
            'Pemberdayaan Usaha Dhuafa & Tanggap Bencana',
            '15 KK terdampingi; 3 aksi kemanusiaan.',
            u.koordinator,
            PlanPriority.MEDIUM,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Pelatihan & stimulan usaha keluarga dhuafa',
                volume: 15,
                unit: 'KK',
                unitPriceJt: 3,
              },
              {
                description: 'Dana siaga tanggap bencana & aksi sosial',
                volume: 3,
                unit: 'aksi',
                unitPriceJt: 10,
              },
          ...
          kegiatan(
            'K-19',
            'Penghijauan & Kebersihan Lingkungan',
            '2 kegiatan penghijauan/kebersihan.',
            u.koordinator,
            PlanPriority.LOW,
            PlanStatus.DRAFT,
            [2, 11],
            ...
            [
              {
                description: 'Bibit tanaman & sarana penghijauan',
                volume: 2,
                unit: 'kegiatan',
                unitPriceJt: 5,
              },
    ...
    },
    {
      ...
      activities: {
        create: [
          kegiatan(
            'K-20',
            'Rapat Pembina, Laporan Tahunan & Perizinan',
            'Laporan tahunan & Rapat Pembina tepat waktu; izin diperpanjang.',
            u.sekretaris,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Penyelenggaraan Rapat Pembina & penggandaan laporan',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 20,
              },
              {
                description: 'Administrasi & legalisasi perizinan',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 15,
              },
          ...
          kegiatan(
            'K-21',
            'Review Eksternal Laporan Keuangan & Sistem Akuntansi',
            'Laporan keuangan 2026 direview eksternal; sistem akuntansi ditata.',
            u.bendahara,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Jasa review eksternal laporan keuangan',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 25,
              },
              {
                description: 'Penataan sistem & pelatihan akuntansi',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 15,
              },
          ...
          kegiatan(
            'K-22',
            'Bimtek Manajemen Kepengurusan',
            '3 pelatihan manajemen kelembagaan & keuangan.',
            u.ketua,
            PlanPriority.MEDIUM,
            PlanStatus.IN_PROGRESS,
            [2, 6, 10],
            ...
            [
              {
                description: 'Pelatihan/bimtek manajemen kelembagaan & keuangan',
                volume: 3,
                unit: 'kali',
                unitPriceJt: 10,
              },
          ...
          kegiatan(
            'K-23',
            'BLK Bahasa, OPOP, Kopontren & Publikasi',
            'BLK 20 peserta; OPOP terverifikasi; Kopontren aktif; website aktif.',
            u.koordinator,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Penataan & operasional BLK Bahasa',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 45,
              },
              {
                description: 'Pendaftaran OPOP & sertifikasi produk/halal',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 25,
              },
              {
                description: 'Penataan & modal kerja awal Kopontren',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 40,
              },
              {
                description: 'Website & publikasi kelembagaan',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 10,
              },
    ...
    },
    {
      ...
      activities: {
        create: [
          kegiatan(
            'K-24',
            'Layanan Rutin Operasional & Personalia Yayasan',
            'Kewajiban rutin personalia & operasional terbayar tepat waktu 12 bulan.',
            u.bendahara,
            PlanPriority.HIGH,
            PlanStatus.IN_PROGRESS,
            ALL_MONTHS,
            ...
            [
              {
                description: 'Bisyaroh/honor pendidik & tenaga kependidikan',
                volume: 12,
                unit: 'bulan',
                unitPriceJt: 55,
              },
              ...
              {
                description: 'ATK & kebutuhan rumah tangga kantor',
                volume: 12,
                unit: 'bulan',
                unitPriceJt: 4,
              },
              {
                description: 'Konsumsi dapur santri/asrama',
                volume: 12,
                unit: 'bulan',
                unitPriceJt: 8,
              },
              {
                description: 'Pemeliharaan ringan gedung & inventaris',
                volume: 1,
                unit: 'paket',
                unitPriceJt: 40,
              },
    ...
    data: {
      ...
      fundingSources: {
        create: [
          {
            order: 0,
            name: 'Uang pendidikan (SPP/infaq bulanan, pendaftaran)',
            basis:
              'Jumlah santri per unit × tarif × 12 bulan + pendaftaran PPDB (sesuai SK Pengurus & data riil).',
            amount: D(2100 * JT),
          },
          {
            order: 1,
            name: 'Dana BOSP (BOS Reguler SD, SMP, SMA)',
            basis:
              'Satuan biaya per daerah (Permendikdasmen No. 8/2026) × siswa ber-NISN — indikatif, menunggu SK penyaluran.',
            amount: D(900 * JT),
          },
          {
            order: 2,
            name: 'Donasi & ZISWAF',
            basis: 'Target Renstra 2027 (indikatif).',
            amount: D(200 * JT),
          },
          {
            order: 3,
            name: 'Pendapatan unit usaha (BLK, Kopontren, OPOP)',
            basis: 'Rintisan; proyeksi konservatif hasil kursus & unit usaha.',
            amount: D(120 * JT),
          },
          {
            order: 4,
            name: 'Hibah/bantuan lain (Kemenag PRA, Pemda sarpras, OPOP)',
            basis: 'Dicatat hanya bila ada penetapan; tidak diandalkan sebagai penyeimbang.',
            amount: null,
          },
          {
            order: 5,
            name: 'Penggunaan saldo awal tahun (bila diperlukan)',
            basis: 'Sesuai posisi kas awal 2027.',
            amount: D(485 * JT),
          },
        ],
      },
  ...
  const smpObjectives: Prisma.PlanObjectiveCreateWithoutPlanInput[] = [
    {
      ...
      indicators: {
        create: [
          indicator({
            name: 'Sesi pembinaan karakter remaja',
            unit: 'sesi',
            baseline: 0,
            targetValue: 3,
            currentValue: 1,
            level: PlanIndicatorLevel.IKK,
            targets: [
              { period: 'TW I', targetValue: 1 },
              { period: 'TW II', targetValue: 1 },
              { period: 'TW III', targetValue: 2 },
              { period: 'TW IV', targetValue: 3 },
            ],
          }),
        ],
      },
    ...
    },
    {
      ...
      indicators: {
        create: [
          indicator({
            name: 'Capaian standar laboratorium',
            unit: '%',
            baseline: 0,
            targetValue: 70,
            currentValue: 40,
