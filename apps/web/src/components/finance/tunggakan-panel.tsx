...
export function TunggakanPanel() {
  ...
  const totalArrears = useMemo(() => {
    return students.reduce(
      (sum: number, student: any) => sum + (student.unpaidAmount || 0),
      0,
    );
  }, [students]);
          ...
          <CardHeader className="pb-3 border-b">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <CardDescription>
                  Pilih unit untuk melihat daftar tunggakan santri
                </CardDescription>
              </div>
            </div>
          </CardHeader>
        ...
        <CardHeader className="border-b">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription>
                Menampilkan tagihan yang belum dibayar
              </CardDescription>
            </div>
            ...
            <TableBody>
              {!selectedUnitId ? (
                <TableRow>
                  ...
                  >
                    Pilih unit sekolah terlebih dahulu untuk melihat data
                    tunggakan.
                  </TableCell>
                </TableRow>
              ) : isLoading ? (
