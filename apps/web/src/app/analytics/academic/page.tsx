    ...
    <div className="container mx-auto py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="bg-rose-50 border-rose-200">
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-rose-700 uppercase font-bold mt-1">
              Santri Berisiko Tinggi
            </p>
          </CardContent>
        </Card>
        ...
        <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="flex items-center p-4 gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Nilai rata-rata mapel di bawah 70% atau penurunan tren
                signifikan.
              </p>
            </div>
          </Card>
          <Card className="flex items-center p-4 gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Akumulasi poin pelanggaran {">"} 50 atau tingkat kehadiran {"<"}{" "}
                85%.
              </p>
            </div>
          </Card>
      ...
      <Card className="shadow-md">
        <CardHeader className="border-b bg-slate-50/50">
          ...
          <CardDescription>
            Berdasarkan analisis lintas modul (Akademik, Tahfidz, dan Karakter)
          </CardDescription>
        </CardHeader>
          ...
          {isLoading ? (
            <div className="py-20 flex flex-col items-center justify-center">
              ...
              <p className="text-muted-foreground">
                Menjalankan mesin analitik holistik...
              </p>
            </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        NIS: {student.nis} • Holistic Score:{" "}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {student.alerts.map((alert: string) => (
                      <Badge
                        key={alert}
                        variant="outline"
                        className="bg-white text-[10px] border-amber-200 text-amber-700"
                      >
                        {alert}
                      </Badge>
                    ))}
            ...
            <div className="py-20 text-center text-muted-foreground">
              ...
              <p>
                Tidak ada santri yang masuk dalam kategori prioritas intervensi
                saat ini.
              </p>
            </div>
          )}
      ...
      <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl flex items-start gap-4">
        ...
        <div>
          <h4 className="text-sm font-bold text-blue-900">
            Standard Operasional Prosedur (SOP) Intervensi
          </h4>
          <p className="text-xs text-blue-800 mt-1 leading-relaxed opacity-80">
            Sesuai dengan Best Practice Manajemen Boarding School, santri dengan
            status <b>CRITICAL</b> wajib mendapatkan sesi konseling psikologis
            dalam waktu maksimal 2x24 jam dan pemberitahuan formal kepada orang
            tua melalui Portal Wali Murid.
          </p>
        </div>
      </div>
    </div>
